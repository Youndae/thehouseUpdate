...
public class PhotoBoardController {
    ...
    private String insertPhotoProc(PhotoBoardVO photoBoardVO,
        ...
        photoBoardService.photoInsertProc(photoBoardVO, mtf, request, session);
    ...
    @ResponseBody
    private void photoDelete(@RequestParam("photoBoardNo") int photoBoardNo, @RequestParam("photoCount") int photoCount, HttpServletRequest request) throws Exception{

        photoBoardService.deletePhotoProc(photoBoardNo, photoCount, request);
    ...
    public Map<String, List<PhotoBoardVO>> photoScrollDown(String idx){
        ...
        log.info("photo Scroll Down idx : " + idx);
    ...
    /*
        insertProc과 updateProc의 수정 이전 코드.
    @RequestMapping("/photoInsertProc")
    private String insertPhotoProc(PhotoBoardVO photoBoardVO,
                                   MultipartHttpServletRequest mtf, HttpSession session, HttpServletRequest request) throws Exception{
    ...
    private String photoUpdateProc(PhotoBoardVO photoBoardVO,
        ...
        update 처리 수정 전 코드.
                photoBoardServiceImpl 코드가 수정된 코드
